...
Kalau belum, baca dulu [Chapter 0 — Pendahuluan](00-pendahuluan.md) — di situ ada link gratis untuk catch-up.
...
Lihat preview gameplay yang akan kita bangun di [Chapter 0 → Preview Akhir Course](00-pendahuluan.md#preview-akhir-course).
...
|---|---------|----------|--------|
| 0 | [Pendahuluan & Persiapan](00-pendahuluan.md) | 30 menit | Mindset & tools terinstall |
| 1 | [Setup Project Unity](01-setup-project.md) | 45 menit | Project 2D URP siap, package terinstall |
| 2 | [Player Character & Movement](02-player-character.md) | 1.5 jam | Karakter jalan 4 arah dengan animasi |
| 3 | [Camera Follow (Cinemachine)](03-camera-follow.md) | 30 menit | Kamera ngikutin player dengan smooth |
| 4 | [Tilemap & Membangun Dunia](04-tilemap-world.md) | 2 jam | Map farm, collider, layer rendering |
| 5 | [Tools System (Hoe, Watering Can, Seed)](05-tools-system.md) | 2 jam | Hotbar + alat aktif & swing animation |
| 6 | [Farming Mechanics](06-farming-mechanics.md) | 3 jam | Till, water, plant, grow, harvest |
| 7 | [Inventory & UI](07-inventory-system.md) | 2.5 jam | Inventory grid + hotbar + drag drop |
| 8 | [Time, Day/Night & Seasons](08-time-day-night.md) | 2 jam | Jam jalan, sleep, ganti musim |
| 9 | [Shop & NPC](09-shop-npc.md) | 2 jam | NPC shopkeeper, beli/jual item |
| 10 | [Save / Load System](10-save-load.md) | 1.5 jam | Save state ke file, load saat start |
| 11 | [Audio, Polish & Build](11-polish-build.md) | 1.5 jam | Music, SFX, build executable |
| 12 | [Next Steps & Resources](12-next-steps.md) | — | Roadmap lanjutan |
...
3. **Selesaikan latihan** di akhir tiap chapter sebelum lanjut. Kalau stuck, lihat solusi di folder [scripts/](https://github.com/ridz15/FarmingCourse/tree/main/scripts).
4. **Commit progress kamu**. Bikin repo Git pribadi, commit di akhir tiap chapter. Nanti waktu bug, gampang revert.
5. **Tanya kalau bingung**. Buka [Issues](https://github.com/ridz15/FarmingCourse/issues) di repo ini, kasih tag chapter & error message.
...
Cara import & setting akan dijelaskan di [Chapter 1 → Step 5: Import Asset Pack](01-setup-project.md#step-5-import-asset-pack).
...
Nemu typo, error, atau punya saran? Buka [Issue](https://github.com/ridz15/FarmingCourse/issues) atau kirim PR! Panduan: [CONTRIBUTING.md](https://github.com/ridz15/FarmingCourse/blob/main/CONTRIBUTING.md).

---

## Lisensi

Materi course (markdown & kode contoh) dirilis dengan lisensi **MIT**. Lihat [LICENSE](https://github.com/ridz15/FarmingCourse/blob/main/LICENSE).
...
Lanjut ke [Chapter 0 — Pendahuluan & Persiapan →](00-pendahuluan.md)
